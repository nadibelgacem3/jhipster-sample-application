package org.pikasoft.mooin.mooincashier.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mooincashier");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("mooincashier");
        ...
        config.getMapConfigs().put("org.pikasoft.mooin.mooincashier.domain.*", initializeDomainMapConfig(jHipsterProperties));

...
import org.pikasoft.mooin.mooinbase.repository.ProductCategoryRepository;
import org.pikasoft.mooin.mooinbase.service.ProductCategoryService;
...
public class ProductCategoryResourceIT {
    ...
    public void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getCompanyID()).isEqualTo(DEFAULT_COMPANY_ID);
    }
    ...
    public void updateProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getCompanyID()).isEqualTo(UPDATED_COMPANY_ID);
    }

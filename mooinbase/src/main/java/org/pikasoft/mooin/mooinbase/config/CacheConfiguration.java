package org.pikasoft.mooin.mooinbase.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mooinbase");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("mooinbase");
        ...
        config.getMapConfigs().put("org.pikasoft.mooin.mooinbase.domain.*", initializeDomainMapConfig(jHipsterProperties));

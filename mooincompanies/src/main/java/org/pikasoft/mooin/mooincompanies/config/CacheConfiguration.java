package org.pikasoft.mooin.mooincompanies.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mooincompanies");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("mooincompanies");
        ...
        config.getMapConfigs().put("org.pikasoft.mooin.mooincompanies.domain.*", initializeDomainMapConfig(jHipsterProperties));

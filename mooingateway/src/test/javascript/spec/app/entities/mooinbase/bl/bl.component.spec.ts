...
import { BLComponent } from 'app/entities/mooinbase/bl/bl.component';
import { BLService } from 'app/entities/mooinbase/bl/bl.service';
import { BL } from 'app/shared/model/mooinbase/bl.model';

describe('Component Tests', () => {
  describe('BL Management Component', () => {
    let comp: BLComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bLS && comp.bLS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { QuoteItemComponent } from 'app/entities/mooinbase/quote-item/quote-item.component';
...
describe('Component Tests', () => {
  describe('QuoteItem Management Component', () => {
    let comp: QuoteItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QuoteItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.quoteItems && comp.quoteItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

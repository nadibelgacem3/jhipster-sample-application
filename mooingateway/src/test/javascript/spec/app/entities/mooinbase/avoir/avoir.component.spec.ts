...
import { AvoirComponent } from 'app/entities/mooinbase/avoir/avoir.component';
...
describe('Component Tests', () => {
  describe('Avoir Management Component', () => {
    let comp: AvoirComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AvoirComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.avoirs && comp.avoirs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

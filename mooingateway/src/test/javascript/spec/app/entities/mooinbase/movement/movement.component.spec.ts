...
import { MovementComponent } from 'app/entities/mooinbase/movement/movement.component';
...
describe('Component Tests', () => {
  describe('Movement Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.movements && comp.movements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

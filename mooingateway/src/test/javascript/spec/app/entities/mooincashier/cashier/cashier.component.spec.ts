...
import { CashierComponent } from 'app/entities/mooincashier/cashier/cashier.component';
...
describe('Component Tests', () => {
  describe('Cashier Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cashiers && comp.cashiers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

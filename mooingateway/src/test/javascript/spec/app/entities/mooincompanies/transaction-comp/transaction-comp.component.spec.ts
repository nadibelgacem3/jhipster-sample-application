...
import { TransactionCompComponent } from 'app/entities/mooincompanies/transaction-comp/transaction-comp.component';
...
describe('Component Tests', () => {
  describe('TransactionComp Management Component', () => {
    let comp: TransactionCompComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TransactionCompComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.transactionComps && comp.transactionComps[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

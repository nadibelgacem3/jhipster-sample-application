...
import { EmployeePaymentComponent } from 'app/entities/mooincompanies/employee-payment/employee-payment.component';
...
describe('Component Tests', () => {
  describe('EmployeePayment Management Component', () => {
    let comp: EmployeePaymentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmployeePaymentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.employeePayments && comp.employeePayments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

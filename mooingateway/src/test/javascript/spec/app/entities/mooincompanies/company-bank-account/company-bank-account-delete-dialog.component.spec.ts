...
import { CompanyBankAccountDeleteDialogComponent } from 'app/entities/mooincompanies/company-bank-account/company-bank-account-delete-dialog.component';
  ...
  describe('CompanyBankAccount Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CompanyBankAccountDeleteDialogComponent],
      })

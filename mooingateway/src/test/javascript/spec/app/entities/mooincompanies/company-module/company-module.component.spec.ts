...
import { CompanyModuleComponent } from 'app/entities/mooincompanies/company-module/company-module.component';
...
describe('Component Tests', () => {
  describe('CompanyModule Management Component', () => {
    let comp: CompanyModuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CompanyModuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.companyModules && comp.companyModules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

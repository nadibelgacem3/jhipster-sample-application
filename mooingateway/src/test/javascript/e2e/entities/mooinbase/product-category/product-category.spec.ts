...
describe('ProductCategory e2e test', () => {
  ...
  it('should load ProductCategories', async () => {
    ...
    expect(await productCategoryComponentsPage.getTitle()).to.eq('mooingatewayApp.mooinbaseProductCategory.home.title');
    await browser.wait(
  ...
  it('should load create ProductCategory page', async () => {
    ...
    expect(await productCategoryUpdatePage.getPageTitle()).to.eq('mooingatewayApp.mooinbaseProductCategory.home.createOrEditLabel');
  ...
  it('should create and save ProductCategories', async () => {
    ...
    await promise.all([
      ...
      productCategoryUpdatePage.setCompanyIDInput('5'),
    ]);
    ...
    expect(await productCategoryUpdatePage.getCompanyIDInput()).to.eq('5', 'Expected companyID value to be equals to 5');
  ...
  it('should delete last ProductCategory', async () => {
    ...
    expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('mooingatewayApp.mooinbaseProductCategory.delete.question');

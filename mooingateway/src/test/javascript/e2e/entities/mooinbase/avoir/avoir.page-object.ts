...
export class AvoirComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-avoir div table .btn-danger'));
  title = element.all(by.css('jhi-avoir div h2#page-heading span')).first();
...
export class AvoirUpdatePage {
  pageTitle = element(by.id('jhi-avoir-heading'));
...
export class AvoirDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-avoir-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-avoir'));

...
export class TiersLocationComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-tiers-location div table .btn-danger'));
  title = element.all(by.css('jhi-tiers-location div h2#page-heading span')).first();
...
export class TiersLocationUpdatePage {
  pageTitle = element(by.id('jhi-tiers-location-heading'));
...
export class TiersLocationDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-tiersLocation-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-tiersLocation'));

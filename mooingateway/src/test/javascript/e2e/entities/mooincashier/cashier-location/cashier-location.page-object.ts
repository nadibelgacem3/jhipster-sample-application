...
export class CashierLocationComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-cashier-location div table .btn-danger'));
  title = element.all(by.css('jhi-cashier-location div h2#page-heading span')).first();
...
export class CashierLocationUpdatePage {
  pageTitle = element(by.id('jhi-cashier-location-heading'));
...
export class CashierLocationDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-cashierLocation-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-cashierLocation'));

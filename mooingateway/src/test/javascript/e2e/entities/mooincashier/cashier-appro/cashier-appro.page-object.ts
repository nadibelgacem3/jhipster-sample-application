...
export class CashierApproComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-cashier-appro div table .btn-danger'));
  title = element.all(by.css('jhi-cashier-appro div h2#page-heading span')).first();
...
export class CashierApproUpdatePage {
  pageTitle = element(by.id('jhi-cashier-appro-heading'));
...
export class CashierApproDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-cashierAppro-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-cashierAppro'));

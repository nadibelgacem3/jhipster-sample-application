...
export class CompanyLocationComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-company-location div table .btn-danger'));
  title = element.all(by.css('jhi-company-location div h2#page-heading span')).first();
...
export class CompanyLocationUpdatePage {
  pageTitle = element(by.id('jhi-company-location-heading'));
...
export class CompanyLocationDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-companyLocation-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-companyLocation'));

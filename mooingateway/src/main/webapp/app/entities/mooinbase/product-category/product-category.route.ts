...
import { IProductCategory, ProductCategory } from 'app/shared/model/mooinbase/product-category.model';
...
export const productCategoryRoute: Routes = [
  {
    ...
    data: {
      ...
      defaultSort: 'id,asc',
      pageTitle: 'mooingatewayApp.mooinbaseProductCategory.home.title',
    },

...
export class TiersComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tiersService
      ...
      .subscribe(
        (res: HttpResponse<ITiers[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTiers(): void {
    this.eventSubscriber = this.eventManager.subscribe('tiersListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITiers[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

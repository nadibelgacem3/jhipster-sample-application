...
export class InvoiceService {
  public resourceUrl = SERVER_API_URL + 'services/mooinbase/api/invoices';
  ...
  protected convertDateFromClient(invoice: IInvoice): IInvoice {
    const copy: IInvoice = Object.assign({}, invoice, {
      date: invoice.date && invoice.date.isValid() ? invoice.date.format(DATE_FORMAT) : undefined,
      dueDate: invoice.dueDate && invoice.dueDate.isValid() ? invoice.dueDate.format(DATE_FORMAT) : undefined,
    });
    return copy;
  }

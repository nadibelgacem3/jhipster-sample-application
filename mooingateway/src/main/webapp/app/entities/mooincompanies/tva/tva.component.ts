...
export class TVAComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tVAService
      ...
      .subscribe(
        (res: HttpResponse<ITVA[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTVAS(): void {
    this.eventSubscriber = this.eventManager.subscribe('tVAListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITVA[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

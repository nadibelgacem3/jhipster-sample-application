...
export class CompanyLocationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.companyLocationService
      ...
      .subscribe(
        (res: HttpResponse<ICompanyLocation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: ICompanyLocation): number {
  ...
  registerChangeInCompanyLocations(): void {
    this.eventSubscriber = this.eventManager.subscribe('companyLocationListModification', () => this.loadPage());
  }

  delete(companyLocation: ICompanyLocation): void {
    const modalRef = this.modalService.open(CompanyLocationDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ICompanyLocation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

...
To build the final jar and optimize the mooingateway application for production, run:
...
Then navigate to [http://localhost:3401](http://localhost:3401) in your browser.
